...
if (isset($_GET['delete_product_id'])) {
    ...
    try {
        if ($id != null) {
            if ($objUser->productdelete($id)) {
                $objUser->redirect('index.php?deletedproduct');
            }
        }
    } catch (PDOException $e) {
        echo $e->getMessage();
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <?php 
                        if (isset($_GET['updated'])) {
                          ...
                          }  else if (isset($_GET['deletedproduct'])) {
                                    echo '<div class="alert alert-warning alert-dismissible fade show" role="alert">
                        ...
                        }else if (isset($_GET['productinserted'])) {
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            <?php if ($stmt->rowCount() > 0) {
                                while ($rowproducts = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
                            <tr>
                                <td><?php print($rowproducts['id']); ?></td>
                                <td>
                                    <a href="form.php?edit_id=<?php print($rowproducts['id']); ?>">
                                        <?php print($rowproducts['product_name']); ?>
                                    </a>
                                </td>
                                <td><?php print($rowproducts['price']); ?></td>
                                <td>
                                    <a class="confirmation"
                                        href="index.php?delete_product_id=<?php print($rowproducts['id']); ?>">
                                        <span data-feather="trash"></span>
                                    </a>
                                </td>
                            </tr>
